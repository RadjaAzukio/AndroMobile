...
public class FirstActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_MESSAGE = "com.example.android.Myapplicatoin2.extra.MESSAGE";
    ...
    public void launchSecondActivity(View view){
        ...
        Intent tampil = new Intent(this,launchSecondActivity().class);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data){
        ...
        if (requestCode == TEXT_REQUEST){
            if (resultCode == RESULT_OK){
                String reply = data.getStringExtra(onActivityResult().EXTRA_REPLY);
